...
- **Status**: ⛔ **DOWN as of 2026-08-13 — production outage, both tiers.**
  - **Compute (Railway)**: almost certainly suspended. Railway's Trial is a **fixed 30-day window**;
    INFRA-03 deployed this app on **2026-07-13**, so the window elapsed **~2026-08-12**. On expiry the
